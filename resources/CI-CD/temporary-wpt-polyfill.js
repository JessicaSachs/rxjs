// Create script element to load RxJS from CDN
...
(function (g, y) {
  ...
  function ae(b, a, c) {
    ...
    function e(a, c) {
      try {
        var b = k[a](c);
        b.value instanceof ba ? Promise.resolve(b.value.v).then(f, h) : l(p[0][2], b);
      } catch (u) {
        l(p[0][3], u);
      }
    }
  ...
  function Ib(b) {
    return b instanceof D || (b && 'closed' in b && t(b.remove) && t(b.add) && t(b.unsubscribe));
  }
  function Jb(b) {
  ...
  function Ba(b) {
    if (S.useDeprecatedSynchronousErrorHandling) {
      ...
      b();
      if (a && ((a = U), (b = a.errorThrown), (a = a.error), (U = null), b)) throw a;
    } else b();
  }
  function Ca(b) {
    S.useDeprecatedSynchronousErrorHandling ? S.useDeprecatedSynchronousErrorHandling && U && ((U.errorThrown = !0), (U.error = b)) : Jb(b);
  }
  function Wa(b, a) {
  ...
  function Lb(b) {
    var a;
    return null !== (a = null !== b && void 0 !== b ? b : S.Promise) && void 0 !== a ? a : Promise;
  }
  function ce(b) {
    var a;
    (a = b && b instanceof na) || (a = b && t(b.next) && t(b.error) && t(b.complete) && Ib(b));
    return a;
  }
  function n(b) {
    return function (a) {
  ...
  function Ob(b) {
    return Symbol.asyncIterator && t(null === b || void 0 === b ? void 0 : b[Symbol.asyncIterator]);
  }
  function Pb(b) {
      ...
      return Ua(this, function (f) {
        switch (f.label) {
          ...
          case 2:
            return [4, ba(a.read())];
          case 3:
            return (c = f.sent()), (d = c.value), (e = c.done) ? [4, ba(void 0)] : [3, 5];
          case 4:
            return [2, f.sent()];
          case 5:
            return [4, ba(d)];
  ...
  function q(b) {
    ...
    if (null != b) {
      ...
      if (Ob(b)) return Sb(b);
      if (Qb(b)) return he(b);
      if (t(null === b || void 0 === b ? void 0 : b.getReader)) return Sb(Rb(b));
    }
    throw Pb(b);
  }
  function ee(b) {
  ...
  function Vb(b, a) {
    if (null != b) {
      ...
      if (t(null === b || void 0 === b ? void 0 : b.then)) return q(b).pipe(ra(a), qa(a));
      if (Ob(b)) return Ub(b, a);
      if (Qb(b)) return Tb(b, a);
      if (t(null === b || void 0 === b ? void 0 : b.getReader)) return Ub(Rb(b), a);
    }
    throw Pb(b);
  }
  function P(b, a) {
      ...
      var e,
        ...
        u = function (a) {
          k = G(
            ...
            function () {
              try {
                e.unsubscribe(), q(f({ meta: l, lastValue: z, seen: g })).subscribe(b);
              } catch (V) {
                b.error(V);
              }
            },
      ...
      c.subscribe(
        m(
          ...
          function (c) {
            ...
            if (v)
              try {
                for (var da = F(v), V = da.next(); !V.done; V = da.next()) (u = V.value), M(e, u), d.next(u);
              } catch (X) {
                g = { error: X };
              } finally {
                try {
  ...
  function Wc() {
    ...
    return Q(function (a) {
      var d = a;
      for (a = 0; a < c; a++) if (((d = null === d || void 0 === d ? void 0 : d[b[a]]), 'undefined' === typeof d)) return;
      return d;
    });
  }
  function Xc(b) {
        ...
        h = function (c, b) {
          var e = m(
            ...
            function (e) {
              var f = b.buffer,
                h = b.complete;
              0 === f.length ? (h ? (d.next(!1), d.complete()) : c.buffer.push(e)) : a(e, f.shift()) || (d.next(!1), d.complete());
            },
            function () {
              c.complete = !0;
              var a = b.buffer;
    ...
    return n(function (a, c) {
      ...
      a.subscribe(
        m(
          ...
          function () {
            d ? (c.next(e), c.complete()) : c.error(f ? new ld('No matching values') : new Z());
          }
        )
      );
    });
      ...
      a.subscribe(
        m(
          ...
          function (a) {
            var f, l;
            try {
              for (var g = F(d), v = g.next(); !v.done; v = g.next()) v.value.next(a);
            } catch (B) {
              f = { error: B };
            } finally {
              try {
            ...
            0 === ++h % c && ((a = new A()), d.push(a), e.next(a.asObservable()));
          },
          function () {
  ...
  function Gd() {
    ...
    return n(function (a, e) {
      ...
      a.subscribe(
        m(e, function (a) {
          k && ((a = x([a], w(h))), e.next(c ? c.apply(void 0, x([], w(a))) : a));
        })
      );
    });
  }
  ...
  function Ne(b) {
    return new r(function (a) {
      var c,
        d,
        e = T({ async: !0, crossDomain: !1, withCredentials: !1, method: 'GET', timeout: 0, responseType: 'json' }, b),
        f = e.queryParams,
        h = e.body,
        g = e.headers,
        k = e.url;
      ...
      f = {};
      if (g) for (var p in g) g.hasOwnProperty(p) && (f[p.toLowerCase()] = g[p]);
      var n = e.crossDomain;
              ...
              null ===
                (c =
                  null === document || void 0 === document
                    ? void 0
                    : document.cookie.match(new RegExp('(^|;\\s*)(' + t + ')\x3d([^;]*)'))) || void 0 === c
                ? void 0
                : c.pop()) && void 0 !== d
            ? d
            : '') &&
      ...
      h = function (c, b) {
        u.addEventListener(c, function () {
          var c,
            d = b();
          null === (c = null === r || void 0 === r ? void 0 : r.error) || void 0 === c ? void 0 : c.call(r, d);
          a.error(d);
        });
      };
      h('timeout', function () {
      ...
      r &&
        [zb, Ab].forEach(function (a) {
          return u.upload.addEventListener(a, function (a) {
            var c;
            return null === (c = null === r || void 0 === r ? void 0 : r.next) || void 0 === c ? void 0 : c.call(r, a);
          });
        });
      e &&
        [zb, Ab].forEach(function (a) {
      ...
      u.addEventListener('error', function (a) {
        var c;
        null === (c = null === r || void 0 === r ? void 0 : r.error) || void 0 === c ? void 0 : c.call(r, a);
        x();
      });
      u.addEventListener(Nd, function (c) {
        var b,
          ...
          e = u.status;
        if (400 > e) {
          null === (b = null === r || void 0 === r ? void 0 : r.complete) || void 0 === b ? void 0 : b.call(r);
          b = void 0;
          try {
  ...
  function Oe(b, a) {
    ...
    if ('object' === typeof b)
      return (
        (a['content-type'] = null !== (c = a['content-type']) && void 0 !== c ? c : 'application/json;charset\x3dutf-8'), JSON.stringify(b)
      );
  ...
  var Ta = function (b, a) {
            ...
            try {
              for (var m = F(a), p = m.next(); !p.done; p = m.next()) {
                ...
                try {
                  ...
                  (f = null !== f && void 0 !== f ? f : []), B instanceof Sa ? (f = x(x([], w(f)), w(B.errors))) : f.push(B);
                }
              }
            } catch (B) {
              b = { error: B };
    ...
    na = (function (b) {
      ...
      a.prototype.complete = function () {
        this.isStopped ? Wa(xa, this) : ((this.isStopped = !0), this._complete());
      };
    ...
    N = {
      ...
      requestAnimationFrame: function () {
        for (var b = [], a = 0; a < arguments.length; a++) b[a] = arguments[a];
        a = N.delegate;
        return ((null === a || void 0 === a ? void 0 : a.requestAnimationFrame) || requestAnimationFrame).apply(void 0, x([], w(b)));
      },
      cancelAnimationFrame: function () {
        for (var b = [], a = 0; a < arguments.length; a++) b[a] = arguments[a];
        a = N.delegate;
        return ((null === a || void 0 === a ? void 0 : a.cancelAnimationFrame) || cancelAnimationFrame).apply(void 0, x([], w(b)));
      },
      delegate: void 0,
    },
    Te = Mb(),
    ...
    Db = (function (b) {
      ...
      a.prototype._subscribe = function (a) {
        var b, c;
        return null !== (c = null === (b = this.source) || void 0 === b ? void 0 : b.subscribe(a)) && void 0 !== c ? c : Pd;
      };
      return a;
    })(A),
    Zc = (function (b) {
    ...
    ma = {
      setImmediate: function () {
        for (var b = [], a = 0; a < arguments.length; a++) b[a] = arguments[a];
        a = ma.delegate;
        return ((null === a || void 0 === a ? void 0 : a.setImmediate) || Ve).apply(void 0, x([], w(b)));
      },
      clearImmediate: function (b) {
        var a = ma.delegate;
        return ((null === a || void 0 === a ? void 0 : a.clearImmediate) || We)(b);
      },
      delegate: void 0,
    },
    Xe = (function (b) {
      ...
      a.prototype.requestAsyncId = function (a, d, e) {
        ...
        a.actions.push(this);
        return a._scheduled || (a._scheduled = ma.setImmediate(a.flush.bind(a, void 0)));
      };
  ...
  var Pa = (function () {
      ...
      b.prototype.accept = function (a, b, d) {
        return t(null === a || void 0 === a ? void 0 : a.next) ? this.observe(a) : this.do(a, b, d);
      };
  ...
  var bf = (function (b) {
          ...
          var g = -1,
            ...
            p = function (a) {
              ...
              switch (h) {
                ...
                case '!':
                  if (Infinity !== k)
                    throw Error("found a second unsubscription point '!' in a subscription marble diagram. There can only be one.");
                  k = -1 < g ? g : m;
                  break;
                default:
    ...
    df = Object.freeze({ ajax: aa, AjaxError: wa, AjaxTimeoutError: Md, AjaxResponse: yb }),
    ef = {
      url: '',
  ...
  g.generate = function (b, a, c, d, e) {
    ...
    var g, l, k;
    1 === arguments.length
      ? ((k = b.initialState), (a = b.condition), (c = b.iterate), (g = b.resultSelector), (l = void 0 === g ? E : g), (e = b.scheduler))
...
window.Subscriber = rxjs.Subscriber;
window.Observer = rxjs.Observer;
window.Subscription = rxjs.Subscription;
